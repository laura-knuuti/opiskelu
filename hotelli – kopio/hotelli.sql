...
--
-- Host: 127.0.0.1
-- Generation Time: 16.04.2025 klo 23:28
...
(5, 'Mikko', 'Mallikas', 'Keudankatu 2', '5100', 'Kerava', 'mikko.m', 'salasana567'),
(6, 'Taika', 'Tintukka', 'Kissankulma 2', '6200', 'Kattila', 'tassuttaja', 'miaumiau');
...
--
ALTER TABLE `asiakkaat`
  MODIFY `AsiakasId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
